...
# T.7: Test aspect ratio too high, 300:600 () → REQUIRES_REVIEW
...
# T.8: Test restricted country in metadata {"market": "iran"} → REQUIRES_REVIEW
...
# T.9: Test child-related → REQUIRES_REVIEW
...
# T.9: Test child-related AND age-prohibited category → REJECTED
...
# T.: Test missing files → 422 error thrown
